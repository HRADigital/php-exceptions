...
use HraDigital\Components\Exceptions\Server\InsufficientStorageException;
use HraDigital\Components\Exceptions\AbstractBaseException;
use HraDigital\Tests\Components\Exceptions\Unit\AbstractExceptionTestCase;

class InsufficientStorageExceptionTest extends AbstractExceptionTestCase
{
    protected function exceptionClass(): string
    {
        return InsufficientStorageException::class;
    }
