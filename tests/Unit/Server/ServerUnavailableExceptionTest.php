...
use HraDigital\Components\Exceptions\Server\ServerUnavailableException;
use HraDigital\Components\Exceptions\AbstractBaseException;
use HraDigital\Tests\Components\Exceptions\Unit\AbstractExceptionTestCase;

class ServerUnavailableExceptionTest extends AbstractExceptionTestCase
{
    protected function exceptionClass(): string
    {
        return ServerUnavailableException::class;
    }
